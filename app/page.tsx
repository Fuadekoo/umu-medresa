          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="border-2 hover:border-primary/50 transition-colors">
              <CardHeader>
                ...
                <CardDescription>{t("expertDescription")}</CardDescription>
              </CardHeader>
            </Card>
            <Card className="border-2 hover:border-primary/50 transition-colors">
              <CardHeader>
            ...
            <Card className="border-2 hover:border-primary/50 transition-colors">
              <CardHeader>
                ...
                <CardDescription>{t("curriculumDescription")}</CardDescription>
              </CardHeader>
            </Card>
            <Card className="border-2 hover:border-primary/50 transition-colors">
              <CardHeader>
                ...
                <CardDescription>{t("programsDescription")}</CardDescription>
              </CardHeader>
            </Card>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <CardHeader>
                ...
                <CardDescription>{t("quranReadingDesc")}</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <CardHeader>
                ...
                <CardDescription>{t("tajweedDesc")}</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <CardHeader>
                ...
                <CardDescription>{t("memorizationDesc")}</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
